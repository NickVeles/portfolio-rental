        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 xl:gap-16">
          {[
            ...
            },
            {
              ...
              description:
                "Once you've found your perfect rental, easily book it online with just a few clicks.",
            },
            {
              imageSrc: "/landing-icon-heart.png",
              title: "Enjoy Your New Home",
              description:
                "Move into your new rental property and enjoy the comfort of your own space.",
            },
          ].map((card, index) => (
